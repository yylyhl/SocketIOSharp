...
namespace SocketIOSharp.Server
{
    public class SocketIOServerOption : EngineIOServerOption
    {
        ...
        /// <param name="Port">Path to listen.</param>
        ...
        /// <param name="VerificationTimeout">connection validation timeout milliseconds</param>
        public SocketIOServerOption(ushort Port, string Path = "/socket.io", bool Secure = false, ulong PingTimeout = 5000, ulong PingInterval = 25000, ulong UpgradeTimeout = 10000, bool Polling = true, bool WebSocket = true, bool AllowUpgrade = true, bool AllowEIO3 = false, bool SetCookie = true, string SIDCookieName = "io", IDictionary<string, string> Cookies = null, Action<HttpListenerRequest, Action<EngineIOException>> AllowHttpRequest = null, Action<WebSocketContext, Action<EngineIOException>> AllowWebSocket = null, object InitialData = null, X509Certificate2 ServerCertificate = null, RemoteCertificateValidationCallback ClientCertificateValidationCallback = null, ulong VerificationTimeout = 1000) : base(Port, Path, Secure, PingTimeout, PingInterval, UpgradeTimeout, Polling, WebSocket, AllowUpgrade, AllowEIO3, SetCookie, SIDCookieName, Cookies, AllowHttpRequest, AllowWebSocket, InitialData, ServerCertificate, ClientCertificateValidationCallback, VerificationTimeout) { }
    }
}
